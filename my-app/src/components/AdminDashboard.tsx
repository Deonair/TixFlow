          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-8">
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-4 sm:p-5">
              ...
              <div className="mt-1 text-2xl font-semibold text-gray-900">
                {(overallStats.revenueCents / 100).toLocaleString('nl-NL', { style: 'currency', currency: 'EUR' })}
              </div>
            </div>
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-4 sm:p-5">
              <div className="text-sm text-gray-500">Tickets verkocht</div>
              <div className="mt-1 text-2xl font-semibold text-gray-900">{overallStats.ticketsSold}</div>
            </div>
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-4 sm:p-5">
              <div className="text-sm text-gray-500">Aantal bestellingen</div>
              <div className="mt-1 text-2xl font-semibold text-gray-900">{overallStats.ordersCount}</div>
            </div>
          </div>
        )}
